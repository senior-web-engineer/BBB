...
ejecute la orden tar zxf aptitude-0.8.10.tar.gz para desempaquetar el código
fuente. Una vez que haya desempaquetado el código fuente, introduzca cd
aptitude-0.8.10 && ./configure && make para compilar aptitude. Si tiene éxito,
...
|                                                |“Paquetes nuevos”).                                                            |
|________________________________________________|___________________________________________________________________________________|
|                                                |Cancel all pending actions from this session (including installations, removals,   |
|Acciones → Cancelar acciones pendientes       |upgrades, holds, marking as automatically installed...). This is roughly equivalent|
...
|10,000|Aptitude::ProblemResolver::Remove-Level, but removing packages was ranked     |ProblemResolver::Keep-   |
|      |higher than keeping the same packages, even if the package was to be upgraded.|All-Level                |
|______|______________________________________________________________________________|_________________________|
...
|________________________________|___________________________________________|______________________________________________________________________________|
|?source-package(nombre)         |~ename                                     |Selecciona paquetes cuyo nombre de paquete fuente coincide con la expresión  |
|                                |                                           |regular nombre.                                                               |
|________________________________|___________________________________________|______________________________________________________________________________|
...
%n        Versión del programa            La longitud de “0.8.10”. No        Mostrar la versión de aptitude que está ejecutando, actualmente “0.8.10”.
...
|______________________|______________|_________________________________________________________________________________|
|Parent                |^, left (in   |Selects the parent of the selected item in a hierarchical list. left is used only|
|                      |package items)|in package items (rows) when showing trees of packages.                          |
|______________________|______________|_________________________________________________________________________________|
...
Descripción: If this option is true, aptitude will clean up obsolete files (see
Acciones → Limpiar ficheros obsoletos) every time you update the package list.
...
Descripción: If this option is true, aptitude will clean up all files in the
package cache directory (see Actions → Limpiar el almacén de paquetes) after
successful installation of packages (or similar operations). This option is
similar to Aptitude::Autoclean-After-Update.
...
Descripción: If this option is enabled, aptitude will use the user's locale for
...
Descripción: How much weight the problem resolver should give to not remove or
...
Descripción: How much weight the problem resolver should give to removing an
...
Descripción: How much to reward or penalize prospective solutions based on their
